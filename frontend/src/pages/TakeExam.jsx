...
import { getExamById, getQuestionsByExam } from '../api/exams';
import { getQuestionsByExam as getQuestions } from '../api/questions';
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className={`px-4 py-2 rounded-lg font-bold ${
                timeRemaining < 300 ? 'bg-red-500 text-white' : 'bg-blue-500 text-white'
              }`}>
