  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex">
      ...
      <div className="flex-1 ml-64">
        <div className="p-8">
          <h2 className="text-3xl font-bold text-neutral-900 mb-8">Reports</h2>

          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-xl font-semibold text-neutral-900 mb-4">Generate Report</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block text-neutral-700 text-sm font-bold mb-2">Report Type</label>
                <select
                  value={reportType}
              ...
              {reportType !== 'performance' && (
                <div>
                  <label className="block text-neutral-700 text-sm font-bold mb-2">Select Exam</label>
                  <select
                    value={selectedExam || ''}
          ...
          {reportData && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold text-neutral-900 mb-6">Report Results</h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="p-4 bg-accent-50 rounded-lg">
                      <p className="text-neutral-600">Total Attempts</p>
                      <p className="text-2xl font-bold">{reportData.statistics.totalAttempts}</p>
                    </div>
                    <div className="p-4 bg-accent-50 rounded-lg">
                      <p className="text-neutral-600">Passed</p>
                      <p className="text-2xl font-bold text-accent-600">{reportData.statistics.passedAttempts}</p>
                    </div>
                  ...
                  <h4 className="font-semibold text-neutral-900 mb-4">Detailed Results</h4>
                  <div className="overflow-x-auto">
                    <table className="min-w-full">
                      <thead>
                        <tr className="bg-primary-50">
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Exam</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Score</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Percentage</th>
              ...
              {reportType === 'passfail' && (
                <div>
                  <div className="mb-6 p-4 bg-primary-50 rounded-lg">
                    <h4 className="font-semibold text-neutral-900 mb-2">Exam Information</h4>
                  ...
                  <div className="p-4 bg-accent-100 rounded-lg mb-6">
                    <p className="text-neutral-600">Pass Rate</p>
                    <p className="text-3xl font-bold text-accent-600">{reportData.statistics.passRate}%</p>
                  </div>

                  <h4 className="font-semibold text-neutral-900 mb-4">Student Results</h4>
                  <div className="overflow-x-auto">
                    <table className="min-w-full">
                      <thead>
                        <tr className="bg-primary-50">
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Student</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Score</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Percentage</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase">Status</th>
                        </tr>
