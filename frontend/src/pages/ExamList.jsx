      ...
      <nav className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <h1 className="text-2xl font-bold text-deepBlue-800">Available Exams</h1>
            <div></div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {loading ? (
          <div className="text-center py-12">
            <p className="text-deepBlue-600">Loading exams...</p>
          </div>
        ) : exams.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-deepBlue-600">No exams available at the moment.</p>
          </div>
        ) : (
            ...
            {exams.map((exam) => (
              <div key={exam.exam_id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition border-2 border-transparent hover:border-purple-300">
                <div className="p-6">
                  ...
                  <div className="space-y-2 text-deepBlue-600">
                  ...
                  <button
                    ...
                    className="mt-6 w-full bg-deepBlue-600 text-white py-3 rounded-lg font-semibold hover:bg-deepBlue-700 transition"
                  >
                    Take Exam
                  </button>
                </div>
